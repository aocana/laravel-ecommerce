<x-app-layout>
    ...
    <div class="grid gap-8 grid-cols-4">
        <form action="{{route('shop.index')}}" method="get" class="row-span-3">
            ...
            <div class="border-t border-gray-200 px-4 py-6">
                <h3 class="-mx-2 -my-3 flow-root">
                    ...
                    <button type="button" id="brandButton" class="px-2 py-3 bg-white w-full flex items-center justify-between text-gray-400 hover:text-gray-500" aria-controls="filter-section-1" aria-expanded="false">
            ...
            <input type="checkbox" name="brand" value="Logitech">Logitech</input>
            <input type="checkbox" name="brand" value="HP">HP</input> -->
