        ...
        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                <div class="flex items-center gap-5">
                    <form class="w-1/2" action="{{route('admin.products.search')}}" method="get">
                        <div class="flex">
                            ...
                            <select name="sort" class="-left-10">
                    ...
                    <a href="{{route('admin.products.index')}}">Clear</a>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium flex items-center justify-center gap-5">
